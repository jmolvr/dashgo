...
//usado para resolver problema do chart que precisa do document.window e assim carrega apenas no browser em vez do back-end no ssr
const Chart = dynamic(() => import("react-apexcharts"), 
    {
        ssr: false // desliga ssr para esse componente
    }
);
